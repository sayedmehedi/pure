...
export default class CreateLawyerScreen extends Component {
  constructor() {
    super();
    this.state = {
      lawyername: '',
  ...
  /*===========Clear All Data After Registration Successful==============*/
  ...
  submitData = async () => {
    ...
    if (
      ...
      this.state.phone !== '' &&
      this.state.password !== '' &&
      this.state.selectedPracticeItems.length !== 0
    ) {
      ...
      formData.append(
        'previous_chamber_name',
        this.state.previous_chamber_name,
      );
      ...
      if (
        ...
        // var array_nodes = [];
        // lawyer_category.selectedList.forEach(function(d) {
      ...
      formData.append(
        'lawcategory',
        JSON.stringify(this.state.selectedPracticeItems),
      );

      const res = await fetch(
        'https://mahatabmemorialclinic.com/api/auth/register/lawyer',
        {
          method: 'POST',
          headers: {
      ...
      if (json.status == 'success') {
        ...
        Alert.alert('Success', 'Lawyer Registration Successful', [
          {
            text: 'Cancel',
      ...
      <View style={{flex: 1}}>
        ...
        <ScrollView
          ...
          <View style={{padding: 18, flex: 1}}>
            ...
            />
            <>
              {this.state.PracticeAreaValidation ? null : (
                <Text
                  style={{
                    fontSize: 12,
                    color: 'red',
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangeBarNameHandle(value);
              }}
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangeEnrolementNumberHandle(value);
              }}
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangeYearsOfPracticeHandle(value);
              }}
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangeRenownedCaseNameHandle(value);
              }}
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangeCurrentChemberHandle(value);
              }}
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={value => {
                this.onChangePreviousChemberHandle(value);
              }}
            ...
            <TextInput
              ...
              onChangeText={value => {
                this.onChangeDetailsHandle(value);
              }}
            ...
            <Button
              ...
              style={{backgroundColor: '#2B3875', marginTop: 5}}>
              <Text style={{fontFamily: 'Roboto-Bold'}}>Add</Text>
            </Button>
            <Button
              icon="pencil-plus"
              mode="contained"
              onPress={this.clearInputField}
              style={{backgroundColor: '#2B3875', marginTop: 5}}>
              <Text style={{fontFamily: 'Roboto-Bold'}}>Clear</Text>
            </Button>
          </View>
        </ScrollView>
      </View>
