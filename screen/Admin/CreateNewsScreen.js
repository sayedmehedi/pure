...
const CreateNewsScreen = props => {
    ...
    if (title.title !== '' && details.details !== '') {
      try {
        ...
        const res = await fetch(
          'https://mahatabmemorialclinic.com/api/news/create',
          {
            method: 'POST',
            headers: {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <CustomHeader title="Create News" navigation={props.navigation} />
      <ScrollView
        ...
        <View style={{padding: 18, flex: 1}}>
          <TextInput
            ...
            onChangeText={value => {
              onChangeTitleHandle(value);
            }}
          />
          <>
            {title.titleValidation ? null : (
              <Text
                style={{
                  fontSize: 12,
                  color: 'red',
          ...
          <>
            {details.detailsValidation ? null : (
              <Text
                style={{
                  fontSize: 12,
                  color: 'red',
